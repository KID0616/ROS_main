...
message(STATUS "master: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imaster:/home/kid/ROS_main/src/master/msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kid/ROS_main/src/master/msg/deg.msg" NAME_WE)
add_custom_target(_master_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "master" "/home/kid/ROS_main/src/master/msg/deg.msg" ""
)
...
_generate_msg_cpp(master
  "/home/kid/ROS_main/src/master/msg/deg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(TARGET geometry_msgs_generate_messages_cpp)
  add_dependencies(master_generate_messages_cpp geometry_msgs_generate_messages_cpp)
endif()
...
if(TARGET geometry_msgs_generate_messages_eus)
  add_dependencies(master_generate_messages_eus geometry_msgs_generate_messages_eus)
endif()
...
if(TARGET geometry_msgs_generate_messages_lisp)
  add_dependencies(master_generate_messages_lisp geometry_msgs_generate_messages_lisp)
endif()
...
if(TARGET geometry_msgs_generate_messages_nodejs)
  add_dependencies(master_generate_messages_nodejs geometry_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/master)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/master\")")
  # install generated code
  install(
...
if(TARGET geometry_msgs_generate_messages_py)
  add_dependencies(master_generate_messages_py geometry_msgs_generate_messages_py)
endif()
